...
# 尝试添加不同的 Tailscale OpenWrt 包源
# sed -i '1i src-git tailscale https://github.com/adyanth/openwrt-tailscale-enabler.git' feeds.conf.default

sed -i '1i src-git passwall https://github.com/Openwrt-Passwall/openwrt-passwall' feeds.conf.default
